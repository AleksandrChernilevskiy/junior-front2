...
export class AppComponent {
  // массив для непосредственно отображения на странице
  listShow:any = [];
  ...
  // обработчик для кнопки - Фильтр пользователей так сказать
  showObj( txt:string ) {

    //console.log( txt );
    //console.log( this.listAlex );

    this.listShow = this.listAlex.filter(  k => k.type == txt );
